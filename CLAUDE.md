...
Start with [AGENTS.md](./AGENTS.md) for the project context.

## Key Resources

- **Context files** (`context/`) — Product definition, architecture, and progress tracking
- **Feature briefs** (`context/features/`) — Compact descriptions of delivered features
- **Trigger.dev skills** (`.agents/skills/trigger-*`) — Task patterns and best practices

## When Building

1. Read the relevant context file first
2. Check feature specs if implementing known functionality
3. Update context after meaningful changes
4. Verify invariants hold before committing

---

<!-- ARCHIVED: The following Trigger.dev docs were retained in attachment form but are no longer inline in this file. Refer to the attachment if needed. -->

<!-- TRIGGER.DEV basic START -->
# Trigger.dev Basic Tasks (v4) [ARCHIVED BELOW]
